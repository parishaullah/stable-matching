...
class SM(Matching):
    ...
    def algorithm(self, splitLeaders, splitFollowers):
        ...
        # at first, some free proposer who hasn't proposed to everyone on the other side must exist
        ...
        if self.leadersPropose:
            ...
            while freeProposerExists:
                ...
                if self.fMatch[follower] == 0:
                    # follower is free, engage leader and follower
            ...
            while freeProposerExists:
                ...
                if self.lMatch[leader] == 0:
                    # leader is free, engage leader and follower
                    self.fMatch[follower] = leader
                    self.lMatch[leader] = follower
